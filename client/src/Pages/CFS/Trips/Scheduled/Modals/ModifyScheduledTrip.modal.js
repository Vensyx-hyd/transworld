...
class ModifyScheduledTripModal extends Component{
	...
	onSubmit() {  
        if (((this.state.driverActive || this.state.startLocationActive || this.state.endLocationActive) === true) && this.state.driverId !== "" && this.state.startLocId !== "" && this.state.endLocId !== "" && (this.state.startLocId !== this.state.endLocId)) {
            ...
            this.setState({
                alert: true,
                alertMessage: "Please Select Driver Name, Start Location or End Location to proceed"
            })
        }
	...
	render(){
        ...
        const { selectedDriverOption, selectedFromLocationOption, selectedToLocationOption } = this.state;  
		return(			
