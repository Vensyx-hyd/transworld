...
class AdminDriverRoaster extends Component{
	constructor(props, context){
        ...
        this.handleDriverChange1 = this.handleDriverChange1.bind(this);
        this.handleDriverChange2 = this.handleDriverChange2.bind(this);
        this.handleDriverChange3 = this.handleDriverChange3.bind(this);
        this.handleDriverChange4 = this.handleDriverChange4.bind(this);
        this.handleLeaveDayChange = this.handleLeaveDayChange.bind(this);
        this.handleDriverChangeUpdate1 = this.handleDriverChangeUpdate1.bind(this);
        this.handleDriverChangeUpdate2 = this.handleDriverChangeUpdate2.bind(this);
        this.handleDriverChangeUpdate3 = this.handleDriverChangeUpdate3.bind(this);
        this.handleDriverChangeUpdate4 = this.handleDriverChangeUpdate4.bind(this);
    ...
    handleTrailerChangeUpdate = (selectedTrailerOptionUpdate) => {
        ...
        // this.handleTrailerSearch(selectedTrailerOptionUpdate.label);
    }
    ...
    handleDriverChange1 = (selectedDriverOption1) => {
        if (selectedDriverOption1 !== null) {
            this.setState({   
                selectedDriverOption1,             
                roasterDriShift1: this.splitName(selectedDriverOption1.label),
                roasterDriShiftID1: selectedDriverOption1.value
            });
        }        
    } 

    handleDriverChange2 = (selectedDriverOption2) => {
        if (selectedDriverOption2 !== null) {
            this.setState({ selectedDriverOption2 });
            this.setState({ 
                roasterDriShift2: this.splitName(selectedDriverOption2.label),
                roasterDriShiftID2: selectedDriverOption2.value
            });
        }        
    }

    handleDriverChange3 = (selectedDriverOption3) => {
        if (selectedDriverOption3 !== null) {
            this.setState({ selectedDriverOption3 });
            this.setState({ 
                roasterDriShift3Leave: this.splitName(selectedDriverOption3.label),
                roasterDriShift3LeaveID: selectedDriverOption3.value
            });
        }        
    } 

    handleDriverChange4 = (selectedDriverOption4) => {
        if (selectedDriverOption4 !== null) {
            this.setState({ selectedDriverOption4 });
            this.setState({ 
                roasterDriShift4Leave: this.splitName(selectedDriverOption4.label),
                roasterDriShift4LeaveID: selectedDriverOption4.value
            });
        }        
    }
    ...
    handleDriverChangeUpdate1 = (selectedDriverOptionUpdate1) => {
        if (selectedDriverOptionUpdate1 !== null ) {
            this.setState({ selectedDriverOptionUpdate1 });
            this.setState({ 
                roasterDriShift1: selectedDriverOptionUpdate1.label,
                shift1: this.splitName(selectedDriverOptionUpdate1.label),
                shiftID1: selectedDriverOptionUpdate1.value,
                
            });
        }
        // } else {
        //     this.setState({ alert: true, alertMessage: "Only One Driver can be changed !" })
        // }   
    } 

    handleDriverChangeUpdate2 = (selectedDriverOptionUpdate2) => {
        if (selectedDriverOptionUpdate2 !== null ) {
            this.setState({ selectedDriverOptionUpdate2 });
            this.setState({ 
                roasterDriShift2: selectedDriverOptionUpdate2.label,
                shift2: this.splitName(selectedDriverOptionUpdate2.label),
                shiftID2: selectedDriverOptionUpdate2.value,
    ...
    handleDriverChangeUpdate3 = (selectedDriverOptionUpdate3) => {
        if (selectedDriverOptionUpdate3 !== null ) {
            this.setState({ selectedDriverOptionUpdate3 });
            this.setState({ 
                roasterDriShift3Leave: selectedDriverOptionUpdate3.label,
                shift1Leave: this.splitName(selectedDriverOptionUpdate3.label),
                shiftID1Leave: selectedDriverOptionUpdate3.value,
    ...
    handleDriverChangeUpdate4 = (selectedDriverOptionUpdate4) => {
        if (selectedDriverOptionUpdate4 !== null ) {
            this.setState({ selectedDriverOptionUpdate4 });
            this.setState({ 
                roasterDriShift4Leave: selectedDriverOptionUpdate4.label,
                shift2Leave: this.splitName(selectedDriverOptionUpdate4.label),
                shiftID2Leave: selectedDriverOptionUpdate4.value,
    ...
    create() {
        ...
        if ( (dateSelectFrom && dateSelectTo) !== null && (roasterTrailerNo && leaveDay && roasterDriShift1 && roasterDriShift2) !== "" && (roasterDriShift1 !== roasterDriShift2) && (roasterDriShift3Leave !== roasterDriShift4Leave) && (roasterDriShift1 !== roasterDriShift3Leave) && (roasterDriShift2 !== roasterDriShift4Leave) && (roasterDriShift1 !== roasterDriShift4Leave) && (roasterDriShift2 !== roasterDriShift3Leave)) {
            this.loader();
        } else if ((roasterDriShift1 && roasterDriShift2) !== "" && roasterDriShift1 === roasterDriShift2) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else if ((roasterDriShift3Leave && roasterDriShift4Leave) !== "" && roasterDriShift3Leave === roasterDriShift4Leave) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else if ((roasterDriShift1 && roasterDriShift3Leave) !== "" && roasterDriShift1 === roasterDriShift3Leave) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else if ((roasterDriShift1 && roasterDriShift4Leave) !== "" && roasterDriShift1 === roasterDriShift4Leave) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else if ((roasterDriShift2 && roasterDriShift3Leave) !== "" && roasterDriShift2 === roasterDriShift3Leave) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else if ((roasterDriShift2 && roasterDriShift4Leave) !== "" && roasterDriShift2 === roasterDriShift4Leave) {
            this.setState({ alert: true, alertMessage: "Drivers should not be Same !" })
        } else {
                            ...
                            <Grid container spacing={24}>       
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChange1}
                            ...
                            <Grid container spacing={24}>     
                                ...
                                <Grid item xs={12} sm={6} md={4}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChange3}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
                                ...
                                <Grid item xs={12} sm={6} md={4}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChange4}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
                            ...
                            <Grid container spacing={24}>       
                                <Grid item xs={12} sm={6} md={5}>
                                    ...
                                    {/* <TextValidator 
                                        ...
                                        name="trailerSearch"
                                        label="Trailer No."
                                        value={this.state.trailerSearch}
                                ...
                                </Grid> 
                                {
                                    ...
                                    ?
                                    <Grid style={{paddingTop: 30, paddingRight: '4%'}} item xs={12} sm={12} md={3}>
                                        <Button 
                                            fullWidth
                                            variant="contained" 
                                            color="primary"
                            ...
                            <Grid container spacing={24}>       
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChangeUpdate1}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
                                ...
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <Select                        
                                        ...
                                        onChange={this.handleDriverChangeUpdate2}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
                            ...
                            <Grid container spacing={24}>     
                                ...
                                <Grid item xs={12} sm={4}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChangeUpdate3}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
                                ...
                                <Grid item xs={12} sm={4}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.handleDriverChangeUpdate4}
                                        options={this.state.drivers}
                                        backspaceRemovesValue={true}
                                        isClearable={true}
                                        isSearchable={true}
